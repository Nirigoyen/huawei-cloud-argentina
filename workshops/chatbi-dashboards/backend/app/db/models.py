...
class Workshop(Base):
    ...
    pg_source: Mapped["PgSource | None"] = relationship(back_populates="workshop", uselist=False, cascade="all, delete-orphan")
...
class PgSource(Base):
    ...
    id: Mapped[UUID] = mapped_column(primary_key=True, default=_uuid)
    workshop_id: Mapped[UUID] = mapped_column(ForeignKey("workshops.id", ondelete="CASCADE"), index=True)
...
class Participant(Base):
    ...
    threads: Mapped[list["Thread"]] = relationship(back_populates="participant", cascade="all, delete-orphan")
    dashboards: Mapped[list["Dashboard"]] = relationship(back_populates="participant", cascade="all, delete-orphan")
...
class Dashboard(Base):
    ...
    items: Mapped[list["DashboardItem"]] = relationship(back_populates="dashboard", cascade="all, delete-orphan")
...
class DashboardItem(Base):
    ...
    id: Mapped[UUID] = mapped_column(primary_key=True, default=_uuid)
    dashboard_id: Mapped[UUID] = mapped_column(ForeignKey("dashboards.id", ondelete="CASCADE"), index=True)
